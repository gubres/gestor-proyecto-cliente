...
final class Version20240409082726 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuarios_proyectos (id INT AUTO_INCREMENT NOT NULL, usuario_id INT DEFAULT NULL, proyecto_id INT DEFAULT NULL, estado TINYINT(1) NOT NULL, fecha_alta DATETIME NOT NULL, fecha_baja DATETIME DEFAULT NULL, INDEX IDX_9BF6E08EDB38439E (usuario_id), INDEX IDX_9BF6E08EF625D1BA (proyecto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE usuarios_proyectos ADD CONSTRAINT FK_9BF6E08EDB38439E FOREIGN KEY (usuario_id) REFERENCES usuarios (id)');
        $this->addSql('ALTER TABLE usuarios_proyectos ADD CONSTRAINT FK_9BF6E08EF625D1BA FOREIGN KEY (proyecto_id) REFERENCES proyectos (id)');
